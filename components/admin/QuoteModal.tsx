...
//     e.preventDefault();
//     if (!bookingId) {
//       alert("Select a booking before creating a quotation");
//       return;
//     }
...
//       <DialogContent className="bg-zinc-900 border-yellow-400/20 text-white">
//         <DialogHeader>
//           <DialogTitle className="text-yellow-400">Create Quotation</DialogTitle>
//         </DialogHeader>
...
//           <div>
//             <Label>Quotation Details / Work Description</Label>
//             <Textarea
//               value={description}
//               onChange={(e) => setDescription(e.target.value)}
//               placeholder="Full service, brake pads replacement, oil change..."
//               rows={5}
//               required
//             />
//           </div>
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="bg-zinc-900 border-yellow-400/20 text-white max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-yellow-400 text-2xl">Create Itemized Quotation</DialogTitle>
        </DialogHeader>
